...
#include <memory>
#include "../../../SettingApp/src/AppEngine.h"
...
QT_MOC_LITERAL(1, 10, 12), // "updateWindow"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 3) // "msg"

    },
    "AppEngine\0updateWindow\0\0msg"
};
...
void AppEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateWindow((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
