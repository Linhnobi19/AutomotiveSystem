...
#include <memory>
#include "../../../SettingApp/src/controller/Translator.h"
...
QT_MOC_LITERAL(1, 11, 22), // "currentLanguageChanged"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 3), // "str"
QT_MOC_LITERAL(4, 39, 14), // "changeLanguage"
QT_MOC_LITERAL(5, 54, 12), // "codeLanguage"
QT_MOC_LITERAL(6, 67, 8), // "saveDate"
QT_MOC_LITERAL(7, 76, 15) // "currentLanguage"

    },
    "Translator\0currentLanguageChanged\0\0"
    "str\0changeLanguage\0codeLanguage\0"
    "saveDate\0currentLanguage"
};
...
void Translator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->currentLanguageChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->changeLanguage((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->saveDate((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Translator::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Translator::currentLanguageChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Translator::currentLanguageChanged(QString _t1)
{
